#!/bin/bash
# MED Pipeline 2: Linear combination of prediction scores [highest MAP]
...
do
    ...
    #echo $feat_str
    python2 validate_pipeline2.py $event $train_video_label $feat_str
    ...
    #echo $feat_model_str
    python2 test_pipeline2.py $event $feat_model_str $score_results $classification_results
done
